...
type PropertyService interface {
	...
	Create(input PropertyInput) (*models.Property, error)
...
func NewPropertyService(propertyRepo repositories.PropertyRepository, authClient *client.AuthClient) PropertyService {
...
func (s *propertyService) Create(input PropertyInput) (*models.Property, error) {
