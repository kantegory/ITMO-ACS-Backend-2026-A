...
interface VacancyRepository : JpaRepository<VacancyEntity, UUID>, JpaSpecificationExecutor<VacancyEntity> {
    override fun findAll(spec: Specification<VacancyEntity>?, pageable: Pageable): Page<VacancyEntity>
}
