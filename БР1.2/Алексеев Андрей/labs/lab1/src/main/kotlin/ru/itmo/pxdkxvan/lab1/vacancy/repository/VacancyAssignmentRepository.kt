package ru.itmo.pxdkxvan.lab1.vacancy.repository
...
interface VacancyAssignmentRepository : JpaRepository<VacancyAssignmentEntity, UUID> {
    fun findAllByVacancyOrderByCreatedAtAsc(vacancy: VacancyEntity): List<VacancyAssignmentEntity>
    fun existsByVacancyAndEmployerProfile(vacancy: VacancyEntity, employerProfile: EmployerProfileEntity): Boolean
}
