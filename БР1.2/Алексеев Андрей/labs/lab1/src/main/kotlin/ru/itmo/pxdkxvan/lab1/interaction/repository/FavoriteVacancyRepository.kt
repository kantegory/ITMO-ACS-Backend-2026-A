...
interface FavoriteVacancyRepository : JpaRepository<FavoriteVacancyEntity, UUID> {
    fun findAllByUser(user: UserAccountEntity, pageable: Pageable): Page<FavoriteVacancyEntity>
    fun findByUserAndVacancy(user: UserAccountEntity, vacancy: VacancyEntity): FavoriteVacancyEntity?
}
