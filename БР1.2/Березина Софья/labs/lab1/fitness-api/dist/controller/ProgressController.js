...
const UserProgress_1 = require("../entity/UserProgress");
class ProgressController {
    static async getProgress(req, res) {
        const { start_date, end_date } = req.query;
        const progressRepo = data_source_1.AppDataSource.getRepository(UserProgress_1.UserProgress);
    ...
    static async getStats(req, res) {
        ...
        res.json({
            ...
            muscle_change: first && last && last.muscle_mass_kg && first.muscle_mass_kg
