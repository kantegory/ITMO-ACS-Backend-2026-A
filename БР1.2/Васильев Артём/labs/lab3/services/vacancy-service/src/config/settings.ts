...
class Settings {
    ...
    DB_PORT = parseInt(env.DB_PORT || env.POSTGRES_PORT) || 15435;
    DB_NAME = env.DB_NAME || env.POSTGRES_DB || 'vacancies_db';
    ...
    DICTIONARY_SERVICE_URL =
        env.DICTIONARY_SERVICE_URL || 'http://localhost:3003/api/v1';
}
