...
class Settings {
    ...
    DB_PORT = parseInt(env.DB_PORT || env.POSTGRES_PORT) || 15433;
    DB_NAME = env.DB_NAME || env.POSTGRES_DB || 'companies_db';
    ...
    AUTH_USER_SERVICE_URL =
        env.AUTH_USER_SERVICE_URL || 'http://localhost:3001/api/v1';
}
