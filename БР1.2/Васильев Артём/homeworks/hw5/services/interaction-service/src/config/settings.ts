...
class Settings {
    ...
    APP_PORT: number = parseInt(env.APP_PORT) || 3007;
    ...
    DB_PORT = parseInt(env.DB_PORT || env.POSTGRES_PORT) || 15438;
    DB_NAME = env.DB_NAME || env.POSTGRES_DB || 'interactions_db';
    ...
    APPLICATION_CREATED_QUEUE =
        env.APPLICATION_CREATED_QUEUE || 'interaction.application.created';
}
