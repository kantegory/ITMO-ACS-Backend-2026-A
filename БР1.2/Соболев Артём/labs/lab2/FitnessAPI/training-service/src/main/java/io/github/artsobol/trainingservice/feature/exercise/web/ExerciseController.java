package io.github.artsobol.trainingservice.feature.exercise.web;
...
import io.github.artsobol.trainingservice.feature.exercise.service.ExerciseService;
...
public class ExerciseController {
    ...
    public SliceResponse<ExerciseResponse> getAll(
            @Parameter(description = "Search by exercise title", example = "push")
            @RequestParam(required = false) String name,
            @ParameterObject Pageable pageable
    ) {
        return SliceResponse.from(exerciseService.getAll(pageable, name));
    }
