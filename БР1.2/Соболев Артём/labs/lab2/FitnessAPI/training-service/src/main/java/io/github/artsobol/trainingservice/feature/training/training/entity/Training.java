package io.github.artsobol.trainingservice.feature.training.training.entity;
...
public class Training {
    ...
    public void addExercise(Long exerciseId) {
        ensureExerciseIdNotNull(exerciseId);

        int nextOrderIndex = exercises.size();

        TrainingExercise entity = TrainingExercise.create(this, exerciseId, nextOrderIndex);
    ...
    private static void ensureExerciseIdNotNull(Long exerciseId) {
        if (exerciseId == null) {
