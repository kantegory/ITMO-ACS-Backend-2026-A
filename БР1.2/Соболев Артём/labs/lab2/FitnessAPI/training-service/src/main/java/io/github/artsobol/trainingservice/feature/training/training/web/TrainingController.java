package io.github.artsobol.trainingservice.feature.training.training.web;
...
import io.github.artsobol.trainingservice.feature.training.training.service.TrainingService;
...
public class TrainingController {
    ...
    public SliceResponse<TrainingResponse> getAll(
            @Parameter(description = "Search by training title", example = "cardio")
            @RequestParam(required = false) String name,
            @ParameterObject Pageable pageable
    ) {
        return SliceResponse.from(trainingService.getAll(pageable, name));
    }
