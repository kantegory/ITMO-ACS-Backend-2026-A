package io.github.artsobol.blogservice.integration.media.rabbit;
...
import io.github.artsobol.blogservice.integration.media.projection.MediaVideoCatalogProjectionService;
...
public class MediaVideoCatalogEventListener {
    ...
    @RabbitListener(queues = RabbitTopology.BLOG_VIDEO_EVENTS_QUEUE)
