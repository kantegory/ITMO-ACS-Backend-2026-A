package io.github.artsobol.blogservice.feature.article.comment.service;
...
import io.github.artsobol.blogservice.feature.article.article.service.ArticleFinder;
import io.github.artsobol.blogservice.feature.article.comment.dto.request.CreateCommentRequest;
import io.github.artsobol.blogservice.feature.article.comment.dto.request.UpdateCommentRequest;
...
import io.github.artsobol.blogservice.feature.article.comment.mapper.CommentMapper;
import io.github.artsobol.blogservice.feature.article.comment.repository.CommentRepository;
...
public class CommentServiceImpl implements CommentService {
    ...
    public CommentResponse createComment(Long userId, Long articleId, CreateCommentRequest request) {
        ...
        Comment entity = Comment.create(userId, article, request.comment());
        repository.save(entity);

        log.info("Comment created commentId={} articleId={} userId={}", entity.getId(), article.getId(), userId);
