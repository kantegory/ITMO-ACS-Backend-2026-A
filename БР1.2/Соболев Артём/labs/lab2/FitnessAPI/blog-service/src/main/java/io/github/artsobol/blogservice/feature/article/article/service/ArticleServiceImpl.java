...
public class ArticleServiceImpl implements ArticleService, ArticleFinder {
    ...
    @Override
    @Transactional(readOnly = true)
    public Slice<ArticleResponse> getAll(Pageable pageable, String name) {
        log.debug(
                "Fetching articles page={} size={} sort={} name={}",
    ...
    public ArticleResponse create(CreateArticleRequest request, Long userId) {
        ...
        Article entity = Article.create(userId, request.title(), request.description());
