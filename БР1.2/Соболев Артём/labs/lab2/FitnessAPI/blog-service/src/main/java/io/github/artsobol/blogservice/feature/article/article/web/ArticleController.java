...
import io.github.artsobol.blogservice.feature.article.article.service.ArticleService;
...
public class ArticleController {
    ...
    public SliceResponse<ArticleResponse> getAll(
            @Parameter(description = "Search by article title", example = "healthy")
            @RequestParam(required = false) String name,
            @ParameterObject Pageable pageable
    ) {
        return SliceResponse.from(articleService.getAll(pageable, name));
    }
