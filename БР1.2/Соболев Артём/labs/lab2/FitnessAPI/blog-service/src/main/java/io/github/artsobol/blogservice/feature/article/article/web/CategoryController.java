package io.github.artsobol.blogservice.feature.article.article.web;
...
import io.github.artsobol.blogservice.feature.article.article.service.CategoryService;
...
public class CategoryController {
    ...
    public SliceResponse<CategoryResponse> getAll(
            @Parameter(description = "Search by category name", example = "healthy")
            @RequestParam(required = false) String name,
            @ParameterObject Pageable pageable
    ) {
        return SliceResponse.from(categoryService.getAll(pageable, name));
    }
