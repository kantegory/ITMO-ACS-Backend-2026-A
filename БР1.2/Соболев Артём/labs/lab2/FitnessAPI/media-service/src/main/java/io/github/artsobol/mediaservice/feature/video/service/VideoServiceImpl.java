...
import io.github.artsobol.mediaservice.feature.video.mapper.VideoMapper;
import io.github.artsobol.mediaservice.feature.video.repository.VideoRepository;
...
import io.github.artsobol.mediaservice.integration.video.rabbit.VideoCatalogEventPublisher;
...
public class VideoServiceImpl implements VideoService, VideoFinder {
    ...
    private final VideoCatalogEventPublisher videoCatalogEventPublisher;
    ...
    public VideoResponse create(CreateVideoRequest request) {
        ...
        repository.flush();
        videoCatalogEventPublisher.publishChanged(entity);
    ...
    public void delete(Long id) {
        ...
        videoCatalogEventPublisher.publishDeleted(entity);
