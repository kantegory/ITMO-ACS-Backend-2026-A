...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	response.RespondJSON(w, http.StatusCreated, map[string]any{"data": toPostFullResponse(post)})
}
...
func (h *Handler) GetByID(w http.ResponseWriter, r *http.Request) {
	...
	response.RespondJSON(w, http.StatusOK, map[string]any{"data": toPostFullResponse(post)})
}
...
func (h *Handler) Brief(w http.ResponseWriter, r *http.Request) {
	...
	response.RespondJSON(w, http.StatusOK, toPostBriefResponse(post))
}
