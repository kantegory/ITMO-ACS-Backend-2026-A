...
export const SETTINGS = {
    ...
    GATEWAY_PORT: numberEnv('GATEWAY_PORT', 8200),
    IDENTITY_HOST: env.IDENTITY_HOST || '127.0.0.1',
    IDENTITY_PORT: numberEnv('IDENTITY_PORT', 8201),
    CATALOG_HOST: env.CATALOG_HOST || '127.0.0.1',
    CATALOG_PORT: numberEnv('CATALOG_PORT', 8202),
    MENU_HOST: env.MENU_HOST || '127.0.0.1',
    MENU_PORT: numberEnv('MENU_PORT', 8203),
    RESERVATION_HOST: env.RESERVATION_HOST || '127.0.0.1',
    RESERVATION_PORT: numberEnv('RESERVATION_PORT', 8204),
    REVIEW_HOST: env.REVIEW_HOST || '127.0.0.1',
    REVIEW_PORT: numberEnv('REVIEW_PORT', 8205),

    IDENTITY_SERVICE_URL: env.IDENTITY_SERVICE_URL || 'http://127.0.0.1:8201',
    CATALOG_SERVICE_URL: env.CATALOG_SERVICE_URL || 'http://127.0.0.1:8202',
    MENU_SERVICE_URL: env.MENU_SERVICE_URL || 'http://127.0.0.1:8203',
    RESERVATION_SERVICE_URL: env.RESERVATION_SERVICE_URL || 'http://127.0.0.1:8204',
    REVIEW_SERVICE_URL: env.REVIEW_SERVICE_URL || 'http://127.0.0.1:8205',

    RABBITMQ_URL: env.RABBITMQ_URL || 'amqp://maindb:maindb@127.0.0.1:5672',
    RABBITMQ_EVENTS_EXCHANGE: env.RABBITMQ_EVENTS_EXCHANGE || 'restaurant.events',
    RABBITMQ_CATALOG_RATING_QUEUE: env.RABBITMQ_CATALOG_RATING_QUEUE || 'catalog.restaurant-rating',

    DB_HOST: env.DB_HOST || '127.0.0.1',
    DB_PORT: numberEnv('DB_PORT', 25432),
