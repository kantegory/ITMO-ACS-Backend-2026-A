...
class RestaurantBookingApiClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype auth_api: restaurantbookingapi.aio.operations.AuthApiOperations
    :ivar users_api: UsersApiOperations operations
    :vartype users_api: restaurantbookingapi.aio.operations.UsersApiOperations
    :ivar reference_api: ReferenceApiOperations operations
    :vartype reference_api: restaurantbookingapi.aio.operations.ReferenceApiOperations
    :ivar restaurants_api: RestaurantsApiOperations operations
    :vartype restaurants_api: restaurantbookingapi.aio.operations.RestaurantsApiOperations
    :ivar reservations_api: ReservationsApiOperations operations
    :vartype reservations_api: restaurantbookingapi.aio.operations.ReservationsApiOperations
    :ivar admin_api: AdminApiOperations operations
    :vartype admin_api: restaurantbookingapi.aio.operations.AdminApiOperations
