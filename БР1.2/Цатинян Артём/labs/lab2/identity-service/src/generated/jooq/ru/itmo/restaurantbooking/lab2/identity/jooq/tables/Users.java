 ...
 */
package ru.itmo.restaurantbooking.lab2.identity.jooq.tables;
...
import ru.itmo.restaurantbooking.lab2.identity.jooq.Identity;
import ru.itmo.restaurantbooking.lab2.identity.jooq.Keys;
...
public class Users extends TableImpl<UsersRecord> {
    ...
    /**
     * The reference instance of <code>identity.users</code>
     */
    ...
    /**
     * The column <code>identity.users.first_name</code>.
     */
    ...
    /**
     * The column <code>identity.users.last_name</code>.
     */
    ...
    /**
     * The column <code>identity.users.phone</code>.
     */
    public final TableField<UsersRecord, String> PHONE = createField(DSL.name("phone"), SQLDataType.VARCHAR(30).nullable(false), this, "");

    /**
     * The column <code>identity.users.role</code>.
     */
    public final TableField<UsersRecord, String> ROLE = createField(DSL.name("role"), SQLDataType.VARCHAR(30).nullable(false).defaultValue(DSL.field(DSL.raw("'CUSTOMER'::character varying"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>identity.users.is_active</code>.
     */
    ...
    /**
     * The column <code>identity.users.created_at</code>.
     */
    ...
    /**
     * The column <code>identity.users.updated_at</code>.
     */
    ...
    /**
     * Create an aliased <code>identity.users</code> table reference
     */
    ...
    /**
     * Create a <code>identity.users</code> table reference
     */
    public Users() {
    ...
    @Override
    public org.jooq.Identity<UsersRecord, Long> getIdentity() {
        return (org.jooq.Identity<UsersRecord, Long>) super.getIdentity();
    }
