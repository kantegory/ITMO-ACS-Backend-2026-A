...
public class Users extends TableImpl<UsersRecord> {
    ...
    /**
     * The reference instance of <code>storage.users</code>
     */
    ...
    /**
     * The column <code>storage.users.first_name</code>.
     */
    ...
    /**
     * The column <code>storage.users.last_name</code>.
     */
    ...
    /**
     * The column <code>storage.users.phone</code>.
     */
    public final TableField<UsersRecord, String> PHONE = createField(DSL.name("phone"), SQLDataType.VARCHAR(30).nullable(false), this, "");

    /**
     * The column <code>storage.users.role</code>.
     */
    public final TableField<UsersRecord, UserRole> ROLE = createField(DSL.name("role"), SQLDataType.VARCHAR(30).nullable(false).defaultValue(DSL.field(DSL.raw("'CUSTOMER'::character varying"), SQLDataType.VARCHAR)), this, "", new EnumConverter<String, UserRole>(String.class, UserRole.class));

    /**
     * The column <code>storage.users.is_active</code>.
     */
    ...
    /**
     * The column <code>storage.users.created_at</code>.
     */
    ...
    /**
     * The column <code>storage.users.updated_at</code>.
     */
    ...
    /**
     * Create an aliased <code>storage.users</code> table reference
     */
    ...
    /**
     * Create a <code>storage.users</code> table reference
     */
    public Users() {
    ...
    public BookingsPath bookings() {
        if (_bookings == null)
            _bookings = new BookingsPath(this, null, Keys.BOOKINGS__FK_BOOKINGS_USER.getInverseKey());
    ...
    public ReviewsPath reviews() {
        if (_reviews == null)
            _reviews = new ReviewsPath(this, null, Keys.REVIEWS__FK_REVIEWS_USER.getInverseKey());
