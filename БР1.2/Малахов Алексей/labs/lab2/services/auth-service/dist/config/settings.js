...
class Settings {
    constructor() {
        ...
        this.DB_PORT = parseInt(process_1.env.DB_PORT) || 5433;
        this.DB_NAME = process_1.env.DB_NAME || 'auth_db';
        this.DB_USER = process_1.env.DB_USER || 'auth_db';
        this.DB_PASSWORD = process_1.env.DB_PASSWORD || 'auth_db';
