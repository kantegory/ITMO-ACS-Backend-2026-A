...
class App {
    constructor() {
        ...
        (0, routing_controllers_1.useExpressServer)(this.app, {
            ...
            controllers: [property_controller_1.default, favorite_controller_1.default, internal_controller_1.default],
            validation: true,
    ...
    start() {
        data_source_1.default.initialize()
            ...
            yield (0, publisher_1.connectPublisher)();
        ...
        this.app.listen(settings_1.default.APP_PORT, settings_1.default.APP_HOST, () => {
            console.log(`[property-service] running on ${settings_1.default.APP_HOST}:${settings_1.default.APP_PORT}`);
        });
    }
}
new App().start();
