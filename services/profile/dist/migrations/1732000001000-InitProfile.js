...
exports.InitProfile1732000001000 = void 0;
class InitProfile1732000001000 {
    ...
    `);
        ...
        await queryRunner.query(`create index idx_resume_summaries_fts on resume_summaries using gin(to_tsvector('simple', content))`);
    }
...
exports.InitProfile1732000001000 = InitProfile1732000001000;
