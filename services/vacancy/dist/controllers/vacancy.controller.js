...
exports.InternalController = exports.VacancyController = void 0;
...
class InternalController {
    static async getCompany(req, res, next) {
        try {
            const company = await vacancy_service_1.VacancyService.getCompanyById((0, params_1.routeParam)(req.params.id));
            res.json((0, mappers_1.toCompanyInternal)(company));
        }
        catch (e) {
            next(e);
        }
