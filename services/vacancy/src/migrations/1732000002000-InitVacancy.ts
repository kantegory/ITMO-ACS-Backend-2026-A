...
export class InitVacancy1732000002000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `create index idx_vacancies_public_search on vacancies(status, industry, experience_level, created_at desc)`,
    );
