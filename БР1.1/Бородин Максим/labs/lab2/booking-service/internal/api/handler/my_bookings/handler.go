...
import (
	...
	uc "github.com/borodin-maksim/restaurant-booking/booking-service/internal/usecase/my_bookings"
)

type useCase interface {
	MyBookings(ctx context.Context, req uc.Request) (*uc.Response, error)
}
...
func (h *Handler) Handle(w http.ResponseWriter, r *http.Request) {
	...
	res, err := h.uc.MyBookings(r.Context(), uc.Request{
		UserID: userID,
		Limit:  limit,
		Offset: offset,
	})
