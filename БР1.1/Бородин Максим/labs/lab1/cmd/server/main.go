...
import (
	...
	"github.com/borodin-maksim/restaurant-booking/internal/app"
	"github.com/borodin-maksim/restaurant-booking/internal/infrastructure/database"
)
...
func main() {
	...
	db, err := database.NewPostgresDB(
		...
		env("DB_NAME", "restaurant_booking"),
