...
import (
	...
	vacancyuc "jobsearch/internal/usecase/vacancy"
...
func toDetail(v *domain.VacancyDetail) map[string]any {
	...
	m["employer"] = map[string]any{
		"id": v.Employer.ID.String(), "company_name": v.Employer.CompanyName,
		"company_description": v.Employer.CompanyDescription,
		"website": v.Employer.Website, "logo_url": v.Employer.LogoURL,
	}
