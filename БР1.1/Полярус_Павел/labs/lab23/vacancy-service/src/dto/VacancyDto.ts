import {
  ...
  IsString, IsUUID, ValidateNested, IsArray,
...
export class CreateVacancyDto {
  ...
  @IsOptional() @IsString() requirementsNote?: string;
  ...
  @IsOptional() @IsInt() salaryFixed?: number;
  @IsOptional() @IsInt() salaryMin?: number;
  @IsOptional() @IsInt() salaryMax?: number;
  @IsOptional() @IsString() currency?: string;
  @IsOptional() @IsInt() experienceYearsMin?: number;
  @IsOptional() @IsInt() experienceYearsMax?: number;
