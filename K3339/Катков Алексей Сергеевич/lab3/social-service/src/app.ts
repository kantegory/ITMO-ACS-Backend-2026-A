...
import { startRecipeEventsConsumer } from './rabbitmq/recipe-events.consumer';
...
dataSource.initialize().then(() => {
    ...
    startRecipeEventsConsumer().catch((error) => {
        console.error('[RabbitMQ] Cannot start recipe events consumer:', error);
    });
